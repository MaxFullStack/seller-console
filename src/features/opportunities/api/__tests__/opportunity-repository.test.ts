...
import type { Opportunity, CreateOpportunityInput, UpdateOpportunityInput } from '../../model/opportunity';
...
describe('OpportunityRepository', () => {
  ...
  describe('update()', () => {
    ...
    it('should throw error when opportunity not found', async () => {
      ...
      await expect(repository.update(input)).rejects.toThrow('Opportunity not found');
    });
  });
