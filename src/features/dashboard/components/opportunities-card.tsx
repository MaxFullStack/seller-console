      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-2 pt-3 border-t">
          <div className="text-center p-2 rounded-md bg-purple-50 border border-purple-100">
            ...
            <div className="text-lg font-bold text-purple-600">{formatPercentage(winRate, 0)}</div>
          </div>
          <div className="text-center p-2 rounded-md bg-blue-50 border border-blue-100">
            ...
            <div className="text-lg font-bold text-blue-600">{formatNumber(activeOpportunities)}</div>
          </div>
        </div>
